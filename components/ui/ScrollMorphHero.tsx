    ...
    return (
        ...
        >
            ...
            >
                {/* Front Face */}
                <div
                    className="absolute inset-0 h-full w-full overflow-hidden rounded-sm shadow-lg bg-neutral-200"
                ...
                {/* Back Face */}
                <div
                    className="absolute inset-0 h-full w-full overflow-hidden rounded-sm shadow-lg bg-neutral-900 flex flex-col items-center justify-center p-2 border border-neutral-700"
            ...
            <div className="flex h-full w-full flex-col items-center justify-center perspective-1000">
                ...
                <div className="absolute z-0 flex flex-col items-center justify-center text-center pointer-events-none top-1/2 -translate-y-1/2 px-4">
                    ...
                    <motion.p
                        ...
                        className="mt-6 text-xs font-bold tracking-[0.2em] text-neutral-500 uppercase"
                    >
                        SCROLL TO EXPLORE
                    </motion.p>
                </div>
