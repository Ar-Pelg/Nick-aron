...
export const ExpertiseItem: React.FC<ExpertiseItemProps> = ({ number, title, desc, tags }) => {
  ...
  return (
    <div 
      className="border-t border-neutral-200 py-12 cursor-pointer group transition-colors duration-500 hover:bg-white"
      onClick={() => setIsOpen(!isOpen)}
      data-cursor={isOpen ? "Sluit" : "Open"}
    >
      <div className="max-w-[1600px] mx-auto px-6 md:px-12 flex flex-col md:flex-row gap-8 md:items-start">
