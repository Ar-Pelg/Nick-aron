  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#FAFAFA] pt-20">
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        >
           <img src="https://images.unsplash.com/photo-1600607686527-6fb886090705?q=80&w=1200&auto=format&fit=crop" className="w-full h-full object-cover opacity-60" loading="eager" alt="Architecture 1" />
        </motion.div>
        <motion.div 
          style={{ y: y2 }} 
        ...
        >
           <img src="https://images.unsplash.com/photo-1545989253-02cc26577f88?q=80&w=1200&auto=format&fit=crop" className="w-full h-full object-cover opacity-60" loading="eager" alt="Architecture 2" />
        </motion.div>
      </div>
      ...
      <div className="relative z-10 text-center max-w-5xl px-6">
        <RevealText className="inline-block" delay={0.2}>
          <span className="inline-block py-1 px-3 border border-neutral-200 rounded-full text-[10px] uppercase tracking-widest mb-6 bg-white">
            Digitale Architectuur & Strategie
          </span>
        </RevealText>
        ...
        <h1 className="font-serif text-6xl md:text-8xl lg:text-[7rem] leading-[0.9] text-neutral-900 mb-8 tracking-tight cursor-default">
          ...
          <RevealText delay={0.4}><span className="italic text-neutral-400 font-light">monumenten.</span></RevealText>
        </h1>
