...
export const Expertise: React.FC<ExpertiseProps> = ({ data, isEditor }) => {
  ...
  return (
    <section className="bg-transparent pt-32 pb-12 relative overflow-hidden" id="expertise">
      ...
      <div ref={itemsRef} className="relative z-10">
        <TracingLine
          ...
          className="absolute left-0 right-0 bottom-0 top-0 pointer-events-none hidden md:block z-0"
        />
